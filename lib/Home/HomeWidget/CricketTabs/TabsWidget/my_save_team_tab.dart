...
import '../../../../HomePage/PaytmTrophy/PaytmTrophyTabBar/my_save_team_preview.dart';
import '../../../../Model/save_team_model.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import '../cricket_tabs.dart';

class MySaveTeamTab extends StatefulWidget {
  final CricketMatchesModel data;
  const MySaveTeamTab({super.key, required this.data});

  @override
  State<MySaveTeamTab> createState() => _MySaveTeamTabState();
}

class _MySaveTeamTabState extends State<MySaveTeamTab> {
  @override
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => MySaveTeamPreview(
                                    saveTeamModel: saveTeamList[index],
                                    upcomingTeamCricket: widget.data)));
                      },
                      child: Padding(
