...
import 'up_c_contests_view.dart';

class UpCoMyContestsTab extends StatefulWidget {
  final MyMatchModel data;
  const UpCoMyContestsTab({super.key, required this.data});

  @override
  State<UpCoMyContestsTab> createState() => _UpCoMyContestsTabState();
}

class _UpCoMyContestsTabState extends State<UpCoMyContestsTab> {
  @override
