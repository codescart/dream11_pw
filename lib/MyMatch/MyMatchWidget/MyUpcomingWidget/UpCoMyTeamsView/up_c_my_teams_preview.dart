...
import 'up_c_my_players_preview_info.dart';

class UpCoMyTeamsPreview extends StatelessWidget {
  final SaveTeamModel saveTeamModel;
  final MyMatchModel myMatchModel;

  const UpCoMyTeamsPreview(
      {super.key, required this.saveTeamModel, required this.myMatchModel});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Text(userData==null?'':'${userData.referralCode}'),
            Container(
              color: Colors.grey[900],
              margin: const EdgeInsets.fromLTRB(5, 0, 0, 0),
              padding: const EdgeInsets.fromLTRB(3, 3, 3, 3),
              child: Text(
                saveTeamModel.teamNumber.toString(),
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      '${saveTeamModel.bowler! + saveTeamModel.allRounder! + saveTeamModel.batsman! + saveTeamModel.wicketKeeper!}/11',
                ...
                children: <Widget>[
                  for (var data in saveTeamModel.playerInfo!)
                    if (data.designationId == '4')
                      UpCoPlayersPreviewInfo(
                          saveTeamModel: data, myMatchModel: myMatchModel)
                ],
              ),
